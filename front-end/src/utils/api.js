...
//create new reservation to database
...
//read reservation by id through a route parameter
...
export async function updateStatus(reservation_id, status, signal){
  const url = new URL(`${API_BASE_URL}/reservations/status`);
  const options = {
    method: "PUT",
    headers,
